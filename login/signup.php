...
<body>
    <div class="full-page">
        <div class="navbar">
            <!--<div><a href="index.html">StudyLah</a></div>-->
            <nav>
                <ul id='MenuItems'>
        ...
        <div class="hero" id='login-form'>
            <div class="form-box">
                ...
                <form id="login" class="input-group">
                    <input type="text" name="StudentEmail" class="input-field" placeholder="User Email" required>
                    <input type="text" name="UserPassword" class="input-field" placeholder="Enter Password" required>
                    <input type="checkbox" class="check-box"><label>Remember Password</label>
                    <button type="submit" class="submit-btn">Log In</button>
                </form>

                <form method="post" enctype="multipart/form-data" onsubmit="return checkValidation()" action="confirmation.html" id="register" class="input-group">
                        ...
                        <input type="password" class="input-field" name="UserPassword" id="UserPassword" maxlength="12" placeholder="Enter Password" required>
                        <input type="password" class="input-field" name="ReUserPassword" id="ReUserPassword" maxlength="12" onkeyup="checkPin()" placeholder="Re-Enter/Confirm Password" required>
                        <div>
                        ...
                        <select name="Residency" class="input-field" required>
                            <option disabled hidden selected>Residency Status</option>
                        ...
                        <select name="Course" class="input-field" required>
                            <option disabled hidden selected>Course</option>
                        ...
                        <select name="YearOfStudy" class="input-field" required>
                            <option disabled hidden selected>Year Of Study</option>
                        ...
                        <label>Current Mods:</label><br>
                            <textarea name="CurrentMod" cols="70" rows="5" id="textareabox" placeholder="CS2040C, CS2100" class="input-field" required></textarea>
                        <input type="checkbox" class="check-box" required><label id="res">I agree to the terms and conditions.</label>
                        <button type="submit" class="submit-btn" name="submitbutton">Registers</button>
...
if(isset($_POST['submitbutton'])){//once button is clicked, php is executed
    ...
    if(mysqli_num_rows($resultcheckduplicate) > 0){//if got rows, got duplicate.
        $url="http://localhost:8080/login/error.php?error=accountexist";
		header('Location:' . $url);
    }
    else{
        ...
        $mail->Body = 'Click here to verify your StudyLah account http://:8080/login/verify.php?token=' .$token.''; // body
